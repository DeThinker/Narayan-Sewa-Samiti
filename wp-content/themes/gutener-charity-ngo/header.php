...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'gutener-charity-ngo' ); ?></a>
	...
	<?php if( get_theme_mod( 'header_layout', 'header_one' ) == '' || get_theme_mod( 'header_layout', 'header_one' ) == 'header_one' ){ ?>
		<header id="masthead" class="site-header header-one">
			<?php
				if( ( !get_theme_mod( 'disable_header_social_links', false ) && !empty( $social_icons ) && is_array( $social_icons ) ) || !get_theme_mod( 'disable_contact_detail', false ) ){ ?>
						...
						<div class="col-lg-10">
							<?php if( has_nav_menu( 'menu-1') ){ ?>
								<nav id="site-navigation" class="main-navigation d-none d-lg-block">
									<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'gutener-charity-ngo' ); ?></button>
									<?php
									wp_nav_menu( array(
