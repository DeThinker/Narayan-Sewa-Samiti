				...
				<?php
					if( !get_theme_mod( 'disable_pagination', false ) ):
						the_posts_pagination( array(
							'next_text' => '<span>'.esc_html__( 'Next', 'gutener-charity-ngo' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'gutener-charity-ngo' ) . '</span>',
							'prev_text' => '<span>'.esc_html__( 'Prev', 'gutener-charity-ngo' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'gutener-charity-ngo' ) . '</span>',
							'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'gutener-charity-ngo' ) . ' </span>',
						));
					endif;
				?>
			</div><!-- #primary -->
